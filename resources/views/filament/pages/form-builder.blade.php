            ...
            <x-filament::section>
                ...
                <div id="field-palette" class="flex flex-col gap-3">
                    @foreach ([
                        ...
                        <div
                            class="fb-palette-item rounded-xl border border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-900/70 p-4 cursor-grab hover:border-primary-400 hover:-translate-y-0.5 transition-all duration-200"
                            data-type="{{ $type }}"
                            data-label="{{ $label }}"
                        >
